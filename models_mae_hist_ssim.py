...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_loss(self, imgs, pred, mask):
        ...
        # print(f"Shape -> {img_norm.shape}, {img_norm}")
        ...
        if self.i % 100 == 0:
            ...
            cv2.imwrite(f"generated_glcm_ssim_covid/{self.i}.png", to_write)
            cv2.imwrite(f"generated_glcm_ssim_covid/{self.i}_rec.png", to_write_rec)
            cv2.imwrite(f"generated_glcm_ssim_covid/{self.i}_rec_original.png", to_write_rec_original)
